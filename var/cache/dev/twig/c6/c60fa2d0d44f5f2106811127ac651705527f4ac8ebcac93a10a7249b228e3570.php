...
<div class=\"example-wrapper\">
    ...
    <h3>Useful links:</h3>
    <ul>
        <li>Accounts : <code><a href=\"";
        // line 16
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("list_accounts");
        echo "\"><button>here</button></a></code></li>
        <li>Transactions : <code><a href=\"";
        // line 17
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("list_transactions");
        echo "\"><button>here</button></a></code></li>
    </ul>
</div>
";
...
<div class=\"example-wrapper\">
    ...
    <h3>Useful links:</h3>
    <ul>
        <li>Accounts : <code><a href=\"{{ path('list_accounts') }}\"><button>here</button></a></code></li>
        <li>Transactions : <code><a href=\"{{ path('list_transactions') }}\"><button>here</button></a></code></li>
    </ul>
</div>
{% endblock %}
